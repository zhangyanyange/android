...
public class ShopcatAdapter extends BaseExpandableListAdapter {
    ...
    private Map<String, List<GoodsInfo.CartsBean.ProductsBean>> childrens;
    ...
    public ShopcatAdapter(List<StoreInfo> groups, Map<String, List<GoodsInfo.CartsBean.ProductsBean>> childrens, Context mcontext) {
        this.groups = groups;
    ...
    public Object getChild(int groupPosition, int childPosition) {
        List<GoodsInfo.CartsBean.ProductsBean> childs = childrens.get(groups.get(groupPosition).getId());
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        final GoodsInfo.CartsBean.ProductsBean child = (GoodsInfo.CartsBean.ProductsBean) getChild(groupPosition, childPosition);
        if (child != null) {
            childViewHolder.goodsName.setText(child.getName());
            childViewHolder.goodsPrice.setText("￥" + child.getSalePrice() + "");
            childViewHolder.goodsNum.setText(String.valueOf(child.getNum()));
//            childViewHolder.goodsImage.setImageResource(R.drawable.cmaz);
            Glide.with(mcontext).load(Constants.Picture_URL1+child.getPicture()).into(childViewHolder.goodsImage);
...
//            childViewHolder.goodsPrimePrice.setText(spannableString);
     ...
     * @param child
     */
    private void showDialog(final int groupPosition, final int childPosition, final View showCountView,final  boolean isChecked, final GoodsInfo.CartsBean.ProductsBean child) {
