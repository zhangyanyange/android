...
public class MaterialAllAdapter extends BaseAdapter {

    public List<MaterialAll.JhBean> data;
    public MaterialAllFragment fragment;

    public MaterialAllAdapter(List<MaterialAll.JhBean> data, MaterialAllFragment fragment) {
        this.data = data;
