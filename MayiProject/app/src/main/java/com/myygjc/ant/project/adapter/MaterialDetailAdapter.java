...
public class MaterialDetailAdapter extends BaseAdapter {
    ...
    public List<MaterialTypeDetail> data;

    private  MaterialDetailFragment fragment;

    public MaterialDetailAdapter(List<MaterialTypeDetail> data, MaterialDetailFragment fragment) {
        this.data = data;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Glide
                ...
                .load("http://123.206.107.160"+data.get(position).getTp()) //指定图片URL
                .placeholder(R.drawable.zhanwei) //指定图片未加载成功前显示的图片
                .error(R.drawable.zhanwei)// 指定图片加载失败显示的图片
                .into(holder.shoptupian); // 指定显示图片的ImageView
