...
import com.microfeel.meiquetiliao.adapter.MakeSureAdapter;
...
public class SureFragment extends BaseFragment {
    ...
    public LoadingPager.LoadedResult initData() {
        mentionMaterial = GetProjectStatusProcotol.getProjectStatus(2, PrefUtils.getString(UIUtils.getContext(),"projectId",""));
    ...
    public View initSuccessView() {
        ...
        MakeSureAdapter adapter = new MakeSureAdapter(getActivity(), mentionMaterial.getListContent());
